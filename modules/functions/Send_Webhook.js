...
module.exports = (MAIN, type, server, content, embed, channel_id) => {
  ...
  let channel = MAIN.BOTS[MAIN.Next_Bot].channels.find(ch => ch.id === channel_id) ? MAIN.BOTS[MAIN.Next_Bot].channels.find(ch => ch.id === channel_id) : MAIN.channels.find(ch => ch.id === channel_id);
