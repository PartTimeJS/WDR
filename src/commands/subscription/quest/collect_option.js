module.exports = (WDR, Functions, source, oMessage, bMessage, Member) => {
  ...
  collector.on("end", (collected, arg) => {
    ...
    switch (arg) {
      case "cancel":
        Functions.Cancel(WDR, Functions, OriginalMsg, Member);
        break;
      case "add":
        Functions.Create(WDR, Functions, OriginalMsg, Member);
        break;
      case "preset":
        Functions.Preset(WDR, Functions, OriginalMsg, Member);
        break;
      case "remove":
        Functions.Remove(WDR, Functions, OriginalMsg, Member);
        break;
      case "view":
        Functions.View(WDR, Functions, OriginalMsg, Member);
        break;
      case "resume":
      case "pause":
