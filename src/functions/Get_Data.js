module.exports = async (MAIN, object) => {
  return new Promise(async resolve => {
    ...
    if(object.pokemon_id){ locale.pokemon_name = WDR.Master.Pokemon[object.pokemon_id].name; }
    if(object.form && object.form > 0){
      ...
      else{ locale.form = '['+WDR.Master.Pokemon[object.pokemon_id].forms[object.form].name+'] '; }
    }
